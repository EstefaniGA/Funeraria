                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        ...
                        <div class="col-md-12  ">
                            ...
                            <?php echo form_open('Orden/agregarOrdenaApoyo') ?>
                            <div class="row">
                                <div class="col-md-3">
                                    <h2 class="center">Folio</h2><input type="text" name="folio" value="<?php
                                    foreach ($fol as $fo) {
                                        echo "JP" . $fo->Folio;
                                    }
                                ...
                                <div class="col-md-3">
                                    <h3 class="center">Orden Comunidad</h3>
                                    <input name="folioapoyo" value="<?php echo $res->idApoyo; ?>" type="hidden" class="form-control">
                                    <input   value="<?php echo $res->idApoyo; ?>" disabled class="form-control">
                                </div>
                                <div class="col-md-3">
                  ...
                  <!--                              <input type="checkbox" name="finado" value="1"> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="benefi" name="beneficiarios">
                                                        <option></option>
                                                        <?php
                                                        foreach ($ben as $be) {
                                                            ?>
                                                            ...
                                                            <option value="<?php echo $be->idBeneficiarios ?>"> <?php echo $be->NombreB . ' ' . $be->ApellidoPa . ' ' . $be->ApellidoMa. ' .......... ' . $be->NombreT; ?></option>
    <?php
}
?>
                                                    </select>
                        ...
                        $(document).ready(function(){
                            $("#benefi").change(function(){
                                $("#benefi option:selected").each(function(){
                                    ben = $("#benefi").val();
                                    
                                    $.post("<?php echo base_url(); ?>index.php/Orden/datos",
                                    {be:ben},function(data){
                                        var registros = eval(data);
                                            $("#nombref").val(registros[0]["NombreB"]);
                                            $("#apellidopa").val(registros[0]["ApellidoPa"]);
                                            $("#apellidoma").val(registros[0]["ApellidoMa"]);
                                            $("#beneficiario").val(registros[0]["NombreT"]);
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nombrefinado" id="nombref" required type="text" placeholder="Nombre" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="apellidopafinado" type="text" id="apellidopa" required placeholder="Apellido Paterno" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label">&nbsp; </label> 
                                                        <input name="apellidomafinado" type="text" id="apellidoma" required placeholder="Apellido Materno" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                    ...
                                    <div class="panel panel-warning">
                                        ...
                                        <div id="collapse2" class="panel-collapse collapse">
                                            <div class="panel-body acord">
                                                <div class="col-md-4">
                                                    <input name="ids" value="<?php echo $res->idSolicitantes ?>" >
                                                    <div class="form-group">
                                                        <label class="control-label">Nombre</label> 
                                                        <input name="nombresolicitante" type="text" placeholder="Nombre" value="<?php echo $res->NombreSolicitante ?>" class="form-control" required >
                                                    </div>  
<?php echo form_error('nombresolicitante'); ?>

                                                    <div class="form-group">
                                                        <label class="control-label">Domicilio</label> 
                                                        <input name="domiciliosolicitante" type="text" value="<?php echo $res->DomicilioSolicitante ?>" required  class="form-control">
                                                    </div> 
<?php echo form_error('domiciliosolicitante'); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="ciudadadsolicitante">
                                                            <option></option>
                                                            <option value="<?php echo $res->idComunidad ?>" selected> <?php echo $res->NombreC ?></option>
...
<?php echo form_error('ciudadsolicitante'); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label">Edad</label> 
                                                        <input name="edadsolicitante" type="number" min="0" max="200" required value="<?php echo $res->Edad ?>" class="form-control">
...
<?php echo form_error('edadsolicitante'); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label">&nbsp;</label> 
                                                        <input name="apellidopasolicitante" required  type="text" placeholder="Apellido Paterno" value="<?php echo $res->ApellidoSolPa ?>" class="form-control">
                                                    </div> 
<?php echo form_error('apellidopasolicitante'); ?>
                                                    <div class="form-group">
                                                        <label class="control-label">Número</label> 
                                                        <input name="numerosolicitante" type="number" class="form-control" value="<?php echo $res->NumeroSolicitante ?>" required >
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label">Colonia</label> 
                                                        <input name="coloniasolicitante" type="text" value="<?php echo $res->ColoniaSolicitante ?>" class="form-control" required >
                                                    </div>
...
if ($res->EstadoCivilSolicitante == "Casado") {
    echo "selected";
}
?> >Casado</option>
                                                            <option value="Soltero" <?php
                                                            if ($res->EstadoCivilSolicitante == "Soltero") {
                                                                echo "selected";
                                                            }
?> >Soltero</option>
                                                            <option value="Divorciado"<?php
                                                            if ($res->EstadoCivilSolicitante == "Divorciado") {
                                                                echo "selected";
                                                            }
?> >Divorciado</option>
                                                            <option value="Viudo" <?php
                                                            if ($res->EstadoCivilSolicitante == "Viudo") {
                                                                echo "selected";
                                                            }
?> >Viudo</option>
                                                        </select>
...
<?php echo form_error('estadociv'); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label">&nbsp;</label> 
                                                        <input name="apellidomasolicitante" type="text" placeholder="Apellido Materno" value="<?php echo $res->ApellidoSolMa ?>" class="form-control" required >
                                                    </div> 
<?php echo form_error('apellidomasolicitante'); ?>
                                                    <div class="form-group">
                                                        <label class="control-label">Parentesco</label> 
                                                       <input name="parentesco" id="beneficiario" required type="text" placeholder="Nombre" class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="telefonosolicitante" minlength="6" maxlength="13" type="number"  value="<?php echo $res->Telefono ?>" class="form-control">
                                                        </div>
